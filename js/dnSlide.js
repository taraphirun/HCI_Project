  ...
  if (typeof define === 'function' && define.amd) {
    ...
    $[_PLUGIN_].prototype = {
        ...
        settingDOM : function (){
            ...
            var coachQuotes = ['one quote','TWO quote','THREE qoute'];
            jQuery.each(this.resourceSrcArr , function(i,e){
                ulDOM.append('<li class="dnSlide-item"><a href="javascript:void(0)"><img class="slide-img" src="'+_this_.resourceSrcArr[i]+'" width="100%"><div class="coachQuote"><p>'+coachQuotes[i]+'</p></div></a></li>');
            });
