...
<body>
    ...
    <div style="background-color:#005051;color:#FCFCFC;">
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="display: inline-block;text-align: center; padding:50px">
                ...
                <h3 style="font-size: 16px">Texas Division Office</h3>
                <p>303.428.2011 phone<br>
                    303.202.0466 facsimile</p>
            </div>
            <div class="col-md-4" style="display: inline-block;text-align: center; padding:50px;">
                <i class="fa fa-envelope-o" style="font-size: 60px" aria-hidden="true"></i><br>
    ...
    <div class="row" style="padding: 50px;background-color:#F8FAF1">
        ...
        <div class="col-md-5" style="display: inline-block;">
            <div class="control-group">
                  ...
                  <input type="text" class="demo-default form-control">
               </div>
               <div class="control-group">
               ...
               <div class="control-group">
                  <label for="select-beast">I'm Interested as:</label><br>
                ...
                <div class="control-group">
                  ...
                  <textarea placeholder="message" rows="5" cols="30"></textarea><br>
                  <br>
    ...
    <h3 style="padding: 50px;color:#142E7A;font-size: 40px;text-align: center;background-color: #EFE8F9;margin-bottom: -20px ">Designed for your kids</h3>
    <div class="row" style="text-align: center;background-color: #EFE8F9">
        <div class="col-md-4">
